...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-[#25D366] text-white shadow-sm hover:bg-[#1da851] active:scale-[0.97]',
        destructive:
          'bg-red-500 text-white shadow-sm hover:bg-red-600 active:scale-[0.97]',
        outline:
          'border border-gray-700 bg-transparent text-gray-200 hover:bg-gray-800 active:scale-[0.97]',
        secondary:
          'bg-gray-800 text-gray-100 shadow-sm hover:bg-gray-700 active:scale-[0.97]',
